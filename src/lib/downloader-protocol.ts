...
export type BrowserInterceptRequest = {
  ...
  injectScript?: string; // Custom JS injection for browser-intercept mode
  onProgress?: (event: { type: 'progress' | 'log'; current?: number; total?: number; message?: string }) => void;
  masterFoundry?: boolean; // Master Foundry Activation
  metadata?: any;
};
...
export type DownloadResult = {
  ...
  specimenAudit?: any;
  pureSuccessLogPath?: string;
  pureSuccessAudit?: any;
  technicalQaLogPath?: string;
  technicalQaAudit?: any;
};
